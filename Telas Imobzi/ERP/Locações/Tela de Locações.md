...
- **Taxas de administração**: Defina o 'Tipo de Administração', as taxas que serão cobradas do Proprietário e se o repasse será automático ou manual. Para 'Imóvel próprio' não há taxas.
	...
	- **Beneficiários**: Define o contato que irá receber o valor de repasse em sua conta bancária. Por padrão o Imobzi seleciona o proprietário como beneficiário.
	...
	- **Modo de repasse**: Caso o repasse seja automático, o repasse pode se comportar de diferentes maneiras;
		- **Repassar e não descontar saldo devedor do locador**: O saldo devedor do locador na conta dos locadores não é descontado 
		- **Repassar e descontar saldo devedor do locador**:
		- **Repassar e descontar somente despesas vinculadas a esta locação**: